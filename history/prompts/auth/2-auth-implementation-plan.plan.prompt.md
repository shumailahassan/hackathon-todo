...
branch: "1-auth"
user: "HC"
command: "/sp.plan auth"
labels: ["authentication", "planning", "architecture", "api-contracts"]
links:
...
prompt_text: |
  /sp.plan auth
response_text: |
  Created comprehensive implementation plan for authentication feature including:
  - Technical context and architecture decisions
  - Research document addressing technology choices
  - Data model for User, Session, and PasswordResetToken entities
