...
export default function CreateDataPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await authService.makeAuthenticatedRequest('/data', {
        method: 'POST',
        headers: {
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-end space-x-3">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50"
                  >
